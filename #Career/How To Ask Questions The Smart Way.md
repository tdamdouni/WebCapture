...
_Captured: 2016-12-23 at 11:05 from [www.catb.org](http://www.catb.org/esr/faqs/smart-questions.html)_
...
Remember, there are many other users that are not experiencing your problem. Otherwise you would have learned about it while reading the documentation and searching the Web (you did do that before complaining, [didn't you](http://www.catb.org/esr/faqs/smart-questions.html)?). This means that very probably it is you who are doing something wrong, not the software.
...
If you're smart enough to ask this question, you're smart enough to [RTFM](http://www.catb.org/esr/faqs/smart-questions.html) and find out yourself.
