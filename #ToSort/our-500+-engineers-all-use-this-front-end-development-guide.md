...
_Captured: 2017-06-15 at 01:11 from [medium.freecodecamp.com](https://medium.freecodecamp.com/grabs-front-end-guide-for-large-teams-484d4033cc41)_

![](https://cdn-images-1.medium.com/freeze/max/30/1*utQ1S74cTsd3fg7dl4VN-g.png?q=20)![](https://cdn-images-1.medium.com/max/800/1*utQ1S74cTsd3fg7dl4VN-g.png)
...
Hence we made our technical decisions based on what was important to a rapidly growing Grab Engineering team -- maintainability and stability of the front end code base. These decisions may or may not apply to smaller teams and projects. Do evaluate what works best for you and your company.
...
If you enjoyed this article, please don't forget to tap ❤. You can also follow us on [Facebook](https://www.facebook.com/grabengineering/) and [Twitter](https://twitter.com/grabengineering).

_This article was originally published on __[Grab's Engineering Blog_](http://engineering.grab.com/grabs-front-end-study-guide)_. The original study guide can be found on __[Github_](https://github.com/grab/front-end-guide)_ and future updates to it will be made there._
